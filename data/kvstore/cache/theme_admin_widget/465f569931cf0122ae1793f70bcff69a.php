<?php exit(); ?>a:3:{s:5:"value";s:3388:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper');  if( $this->_vars['data']['top_html'] ){  echo $this->_vars['data']['top_html'];  } ?>
<form style="margin-left:5px" action="<?php echo kernel::router()->gen_url(array('app' => b2c,'ctl' => site_search,'act' => result)); ?>" method="post" class="SearchBar  searchBar_<?php echo $this->_vars['widget_id']; ?>">
  <table cellpadding="0" cellspacing="0">
    <tr>
      ...
      <!-- <td><a href="<?php echo kernel::router()->gen_url(array('app' => b2c,'ctl' => site_search,'act' => index)); ?>" class="btn_advsearch"><?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>高级搜索<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?></a> </td> -->
    </tr>
  </table>

</form>
<?php if( $this->_vars['data']['bottom_html'] ){  echo $this->_vars['data']['bottom_html'];  } ?>
";s:8:"dateline";s:10:"1369129340";s:3:"ttl";s:1:"0";}