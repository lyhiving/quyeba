<?php exit(); ?>a:3:{s:5:"value";s:2165:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><div class="tableform widgetconfig">
<div class="division">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><input name="className" value="<?php echo ((isset($this->_vars['setting']['className']) && ''!==$this->_vars['setting']['className'])?$this->_vars['setting']['className']:'menu_index'); ?>" size=15/></td>
  </tr>	
</table>

</div>
</div>";s:3:"ttl";i:0;s:8:"dateline";i:1437787264;}