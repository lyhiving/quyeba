...
'comment.switch.extend'=>array('type'=>SET_T_STR,'default'=>'on','desc'=>app::get('b2c')->_('商品详情页科技课堂开关')),
'comment.switch.size'=>array('type'=>SET_T_STR,'default'=>'on','desc'=>app::get('b2c')->_('商品详情页尺寸开关')),
